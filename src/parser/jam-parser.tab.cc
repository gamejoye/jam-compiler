...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_classList = 43,                 /* classList  */
  YYSYMBOL_feature = 44,                   /* feature  */
  YYSYMBOL_notemptyFeatureList = 45,       /* notemptyFeatureList  */
  YYSYMBOL_featureList = 46,               /* featureList  */
  YYSYMBOL_formal = 47,                    /* formal  */
  YYSYMBOL_notemptyFormalList = 48,        /* notemptyFormalList  */
  YYSYMBOL_formalList = 49,                /* formalList  */
  YYSYMBOL_expression = 50,                /* expression  */
  YYSYMBOL_notemptyExpressionList = 51,    /* notemptyExpressionList  */
  YYSYMBOL_expressionList = 52,            /* expressionList  */
  YYSYMBOL_statement = 53,                 /* statement  */
  YYSYMBOL_notemptyStatementList = 54,     /* notemptyStatementList  */
...
static const char *const yytname[] =
{
  ...
  "featureList", "formal", "notemptyFormalList", "formalList",
  "expression", "notemptyExpressionList", "expressionList", "statement",
  "notemptyStatementList", "statementList", YY_NULLPTR
};
